...
public class Board {
	...
	public String toString() {
		return "Board [boardId=" + boardId + ", categoryId=" + categoryId + ", writer=" + writer + ", email=" + email
				+ ", password=" + password + ", title=" + title + ", writeDate=" + writeDate + ", masterId=" + masterId
				+ ", readCount=" + readCount + ", replyNumber=" + replyNumber + ", replyStep=" + replyStep + ", seq="
				+ seq + ", category=" + category + ", fileId=" + fileId + ", fileName=" + fileName + ", fileSize="
